...
public class PrikazIzvjestajaSumarniGUI extends JFrame{
	
	private IzvjestajKontroler ik = new IzvjestajKontroler();
	Date datum1;
	Date datum2;
	
	public PrikazIzvjestajaSumarniGUI(Date d1, Date d2) {
				...
				naslovLbl.setHorizontalAlignment(SwingConstants.RIGHT);
				 ...
				 naslovLbl.setText("Sumarni izvještaj");
				...
				String imenaKolona[] = {"Radnik", "Ukupno sati rada"};
				...
				try {
					ik.napuniTabeluSumarni(tableModel, sqld1, sqld2);
				}
				catch(Exception e) {
				...
				exportBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							ik.napraviPdfSumarni(sqld1, sqld2);
						}
						catch(Exception ex) {
							JOptionPane.showMessageDialog(rootPane,
								    "Greška. Pojavio se izuzetak.",
