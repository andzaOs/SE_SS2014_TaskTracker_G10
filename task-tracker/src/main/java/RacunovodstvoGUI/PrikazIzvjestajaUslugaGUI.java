...
public class PrikazIzvjestajaUslugaGUI extends JFrame{
	...
	public PrikazIzvjestajaUslugaGUI(VrstaUsluge v, Date d1, Date d2) {
				...
				naslovLbl.setHorizontalAlignment(SwingConstants.RIGHT);
				 ...
				 naslovLbl.setText("Izvještaj za uslugu: ");
				...
				String imenaKolona[] = {"Radnik", "Klijent", "Datum", "Broj sati"};
				...
				try {
					ik.napuniTabeluUsluga(tableModel, vu, sqld1, sqld2);
				}
				catch(Exception e) {
				...
				exportBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							ik.napraviPdfUsluga(vu, sqld1, sqld2);
						}
						catch(Exception ex) {
							JOptionPane.showMessageDialog(rootPane,
								    "Greška. Pojavio se izuzetak.",
