...
public class PrikazIzvjestajaRadnikGUI extends JFrame{
	...
	public PrikazIzvjestajaRadnikGUI(Korisnik k, Date d1, Date d2) {
				...
				naslovLbl.setHorizontalAlignment(SwingConstants.RIGHT);
				 ...
				 naslovLbl.setText("Izvještaj za servisera: ");
				...
				String imenaKolona[] = {"Vrsta usluge", "Klijent", "Datum", "Broj sati"};
				...
				try {
					ik.napuniTabeluRadnik(tableModel, k, sqld1, sqld2);
				}
				catch(Exception e) {
				...
				exportBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							ik.napraviPdfRadnik(kor, sqld1, sqld2);
						}
						catch(Exception ex) {
							JOptionPane.showMessageDialog(rootPane,
								    "Greška. Pojavio se izuzetak.",
