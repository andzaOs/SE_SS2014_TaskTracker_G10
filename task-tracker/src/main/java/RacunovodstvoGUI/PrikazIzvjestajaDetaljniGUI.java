...
public class PrikazIzvjestajaDetaljniGUI extends JFrame{
	
	private IzvjestajKontroler ik = new IzvjestajKontroler();
	Date datum1;
	Date datum2;
	
	public PrikazIzvjestajaDetaljniGUI(Date d1, Date d2) {
				...
				naslovLbl.setHorizontalAlignment(SwingConstants.RIGHT);
				 ...
				 naslovLbl.setText("Detaljni izvještaj");
				...
				try {
					ik.napuniTabeluDetaljni(tableModel, sqld1, sqld2);
				}
				catch(Exception e) {
				...
				exportBtn.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						try {
							...
							ik.napraviPdfDetaljni(sqld1, sqld2);
						}
						catch(Exception ex) {
							JOptionPane.showMessageDialog(rootPane,
								    "Greška. Pojavio se izuzetak.",
