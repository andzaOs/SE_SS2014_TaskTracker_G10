...
public class KorisnikKontroler {
	...
	public Boolean kreiranjeKorisnika(Boolean dat, JTextField imeTxt, JTextField prezimeTxt, JTextField jmbgTxt, JTextField brojLKTxt, JTextField adresaTxt,  JTextField telefonTxt, JTextField emailTxt, Date d, JTextField korisnickoImeTxt, JLabel sifraTxt, TipKorisnika tip,JDatePickerImpl polje,Date datum) throws Exception {
			try {
